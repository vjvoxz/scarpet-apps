...
_spread_down(pos, lichen_block) -> (
    ...
    if(_is_air(below_block),
        if(state:'north' == 'true' && rand(1) < 0.5,
            set(below, 'glow_lichen', 'north', 'true')
        );
        if(state:'south' == 'true' && rand(1) < 0.5,
            set(below, 'glow_lichen', 'south', 'true')
        );
        if(state:'east' == 'true' && rand(1) < 0.5,
            set(below, 'glow_lichen', 'east', 'true')
        );
        if(state:'west' == 'true' && rand(1) < 0.5,
            set(below, 'glow_lichen', 'west', 'true')
        );
    ,
        if(state:'north' == 'true' && rand(1) < 0.5 && _can_attach([x, y-1, z-1]),
            set(below, 'glow_lichen', 'north', 'true')
        );
        if(state:'south' == 'true' && rand(1) < 0.5 && _can_attach([x, y-1, z+1]),
            set(below, 'glow_lichen', 'south', 'true')
        );
        if(state:'east' == 'true' && rand(1) < 0.5 && _can_attach([x+1, y-1, z]),
            set(below, 'glow_lichen', 'east', 'true')
        );
        if(state:'west' == 'true' && rand(1) < 0.5 && _can_attach([x-1, y-1, z]),
            set(below, 'glow_lichen', 'west', 'true')
        );
    );
);
...
_spread_horizontal_direction(pos, state, direction, target) -> (
    ...
    if(direction == 'north',
        if(state:'east' == 'true' && _can_attach([tx+1, ty, tz]),
            set(target, 'glow_lichen', 'east', 'true')
        );
        if(state:'west' == 'true' && _can_attach([tx-1, ty, tz]),
    ...
    if(direction == 'east',
        if(state:'north' == 'true' && _can_attach([tx, ty, tz-1]),
            set(target, 'glow_lichen', 'north', 'true')
        );
        if(state:'south' == 'true' && _can_attach([tx, ty, tz+1]),
